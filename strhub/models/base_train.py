...
class BaseSystem(pl.LightningModule, ABC):
    ...
    def _eval_step(self, batch, validation: bool) -> Optional[STEP_OUTPUT]:
        ...
        # destination_folder = "/home/shashank_kv/scratch/parseq/Kannada/kannada_realworld_wronglypredicted/"
        # wordfile = "/home/shashank_kv/scratch/parseq/Kannada/kannada_realworld_images/gt.txt"
